...
let TOP_OFFSET;// = Layout.headerHeight();
...
class ImageGallery extends React.Component {
  ...
  constructor(props, context) {
    ...
    //navigation v6 retrieve header height on run time
    if(!Layout.headerHeight){
      Layout.headerHeight = useHeaderHeight();
      TOP_OFFSET = Layout.headerHeight;
      styles = StyleSheet.create({...styles,
                                  headerBar:{...styles.headerBar,height:Layout.headerHeight},
                                  list:{...styles.list,top:Layout.headerHeight}
                                 });
//       if(__DEV__){
        console.log('found header height = ',Layout.headerHeight,',then set to style = ',styles);
//       }
    }
  }
